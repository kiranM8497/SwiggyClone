...
const RestraurantCard = ({
  ...
  return (
    <div
      data-testid="resCard"
      className="m-4 px-4 pt-2 pb-3 w-[250px] rounded-xl bg-gray-100 min-h-[550px] max-h-[650px] flex flex-col hover:bg-gray-300  "
    >
      ...
      <div className="m-6 ">
        ...
        <h4 className="font-semibold py-1.1">
        ...
        {/* <h4 font-semibold pt-2>User: {loggedInUser}</h4> */}
      </div>
    </div>
  );
};
