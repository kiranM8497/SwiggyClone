...
const RestaurantMenu = () => {
  ...
  return (
    <div className="w-[100%]" data-testid="menu-items">
      ...
      <div className="60% mx-[20%]  ">
        <div className="flex">
          <ul>
            {menuItems.map((item) => (
              <div key={item?.id} data-testid="menu-items">
                  ...
                  <div className="w-full border-gray-100 border-t-2 border-b-2 flex hover:bg-gray-300 px-4 py-8">
                    ...
                    <div className="w-3/12 flex justify-between">
                      ...
                      <div className="flex pt-9 ">
                        <button
                          className=" w-auto rounded-lg text-black-400 w-22 m-2 px-4 justify-center text-center h-10 bg-gray-200 hover:bg-green-400"
